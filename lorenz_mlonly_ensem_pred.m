function [X3,Y3,v4,mean_var_z] = lorenz_mlonly_ensem_pred(ls,v0,rho,tp,hp,part_id)
% Ensemble prediction for the Lorenz system using the ML-only method 
%
% Inputs:
...
[Wout, S, S_avg] = res_train_linear_id(A,Win,vtrain,vtarget,tw,mp,eps0,g5,g6,g4); 
...
u = res_predict_linear_id(A,Win,Wout,S,id(tt:end),g5,g6,TT,samp_noise);
